...
ActiveRecord::Schema.define(version: 2021_06_04_072351) do
  ...
  create_table "employees", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    ...
    t.index ["country"], name: "fk_country_idx"
    t.index ["deleted_at"], name: "index_employees_on_deleted_at"
    t.index ["project"], name: "fk_project_idx"
    t.index ["role"], name: "fk_role_idx"
  end
  ...
  add_foreign_key "employees", "tag_types", column: "country", name: "fk_country"
  add_foreign_key "employees", "tag_types", column: "project", name: "fk_project"
  add_foreign_key "employees", "tag_types", column: "role", name: "fk_role"
end
